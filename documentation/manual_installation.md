...
```bash
pip install -r requirements.txt tts-webui-extension.rvc>=0.0.3 tts-webui-extension.styletts2>=0.1.0 hydra-core==1.3.2 nvidia-ml-py --extra-index-url https://tts-webui.github.io/extensions-index/
```
