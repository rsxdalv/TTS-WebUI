...
# add xformers?
RUN pip install --no-cache-dir setuptools torch==$TORCH_VERSION torchvision==$TORCH_VERSION torchaudio==$TORCH_VERSION --index-url https://download.pytorch.org/whl/cu128
